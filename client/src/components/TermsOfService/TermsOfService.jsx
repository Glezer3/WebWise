...
const TermsOfService = () => {
  ...
  <div data-custom-class="body">
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <bdt className="question">Slovakia</bdt>
                    <bdt className="statement-end-if-in-editor">
                      <span
                        style={{
                          fontSize: "11.0pt",
                ...
                at <bdt className="question"></bdt>
                <bdt className="block-component" />{" "}
                <bdt className="question">krizovatka</bdt>
                <span
                  style={{
                    fontSize: "11.0pt",
                    lineHeight: "115%",
                ...
                , <bdt className="question">Banska Stiavnica</bdt>
              </span>
            </span>
                ...
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      ...
                      <bdt className="statement-end-if-in-editor" />
                      <bdt className="block-component" />{" "}
                      <bdt className="question">96901</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </span>
                  </span>
                </span>
    ...
    <div style={{ textAlign: "justify" }}>
      ...
      >
        ...
        >
          ...
          phone at <bdt className="question">+421 915 213 000</bdt>, email at{" "}
          <bdt className="question">help.webwise@gmail.com</bdt>
          <bdt className="block-component" />,
          <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
          <bdt className="question">jakubbukaj5@gmail.com</bdt>
          <bdt className="block-component" />,{" "}
          <bdt className="question">krizovatka</bdt>
          <bdt className="statement-end-if-in-editor" />,{" "}
          <bdt className="question">Banska Stiavnica</bdt>
      ...
      >
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">WebWise Home Control</bdt>,
      ...
      >
        ...
        >
          ...
          <bdt className="question">help.webwise@gmail.com</bdt>, as stated in
    ...
    <div style={{ textAlign: "justify" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">help.webwise@gmail.com</bdt>. If we ever
    ...
    <div style={{ textAlign: "justify" }}>
      ...
      >
        <div className="MsoNormal" style={{ lineHeight: "17.25px" }}>
          ...
          <div
            className="MsoNormal"
            style={{ lineHeight: "1.1", textAlign: "justify" }}
          >
            <bdt className="block-component" />
          </div>
          <div
        ...
        >
          ...
          >
            <bdt
              ...
              style={{ color: "rgb(10, 54, 90)", textAlign: "justify" }}
            >
              <bdt data-type="body">
                <div
                  className="MsoNormal"
        ...
        >
          ...
          <div className="MsoNormal" style={{ lineHeight: "17.25px" }}>
            ...
            <ul style={{ fontSize: "medium", textAlign: "justify" }}>
        ...
        >
          ...
          >
            ...
            may not <bdt className="block-component" />
            organize
        ...
        >
          ...
          >
            ...
            >
              ...
              and sublicensable right and <bdt className="block-component" />
              license
                          ...
                          >
                            <bdt data-type="conditional-block">
                              ...
                              <bdt data-type="body">
                                ...
                                will delete that information from the Services
        ...
        >
          ...
          >
            ...
            <bdt className="question">WebWise Home Control</bdt> and yourself
            both agree to submit to the non-exclusive jurisdiction of the courts
            of <bdt className="question">Banska Stiavnica</bdt>, which means that
        ...
        >
          <span style={{ fontSize: 15 }}>
            ...
            least <bdt className="question">30</bdt> days before
        ...
        >
          ...
          be <bdt className="question">at least 5</bdt>. The seat, or legal
          place, or arbitration shall be <bdt className="block-component" />
          <bdt className="block-component" />
          <bdt className="block-component" />
          <bdt className="question">10</bdt>
          <bdt className="statement-end-if-in-editor">
            <bdt className="statement-end-if-in-editor" />
            <bdt className="statement-end-if-in-editor" />
          </bdt>
          . The language of the proceedings shall be{" "}
          <bdt className="question">Slovak language</bdt>. The governing law of these
        ...
        >
          <span style={{ fontSize: 15 }}>
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <bdt className="question">
                <strong>WebWise Home Control</strong>
              </bdt>
              <strong>
                <bdt className="block-component" />
              </strong>
        ...
        >
          <strong>
            ...
            >
              <strong>
                <bdt className="block-component" />
                Phone: <bdt className="question">+421 915 213 000</bdt>
                <bdt className="statement-end-if-in-editor" />
              </strong>
            </span>
          </strong>
    ...
    />
      ...
      <button className="button" style={{margin: "2rem auto 0 auto", display: "flex"}}><a href="/signup" style={{alignSelf: "center"}}>Got it</a></button>
...
export default SectionWrapper(TermsOfService, "terms-of-service")